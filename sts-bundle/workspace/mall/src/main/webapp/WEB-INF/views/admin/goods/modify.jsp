...
<script>
	...
	for(var i=0; i<cate1Arr.length; i++) {
	    cate1Select.append(
	        "<option value='"+cate1Arr[i].cateCode+"'>"+cate1Arr[i].cateName+"</option>")
	}
...
//         cate2Select.append(
//             "<option value='" + cate2Arr[i].cateCode + "'>" + cate2Arr[i].cateName + "</option>")
//     }
...
if(select_cateCodeRef != null && select_cateCodeRef != '') {
    ...
    $(".category2").append(
    		"<option value='"+select_cateCode+"'>"+select_cateName+"</option>");
} else {
