...
public class StreamEx8 {
	public static void main(String[] args) {
		...
		Map<Student4.Level, Long> stuCntLevel = Stream.of(stuArr)
				.collect(groupingBy(s -> {
						 if(s.getScore() >= 200) return Student4.Level.HIGH;
					else if(s.getScore() >= 100) return Student4.Level.MID;
					else 						 return Student4.Level.LOW;
				...
				, counting()));
		for(Student4.Level key : stuCntLevel.keySet())
			System.out.printf("[%s] - %d명, ", key, stuCntLevel.get(key));
		System.out.println();
		...
		Map<String, Set<Student4.Level>> stuByScoreGroup = 
		Stream.of(stuArr)
			.collect(
